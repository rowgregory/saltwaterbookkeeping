  ...
  return (
    <Fragment>
      ...
      <div className="px-4 py-32">
        <div className="max-w-screen-md lg:max-w-screen-lg xl:max-w-screen-1200 mx-auto w-full grid grid-cols-12 gap-y-20 lg:gap-x-20">
          <div className="col-span-12 lg:col-span-5">
            <span className="text-aquablue uppercase roboto-bold tracking-wide text-sm">
              Need Any Help?
            </span>
            <AnimatedText text="Get in touch with us" />
            <p className="roboto-regular text-gray-400 mb-12">
            ...
            <div className="grid grid-cols-12 md:gap-4 mb-16 group">
              <div className="col-span-3 bg-aqua-g w-12 h-12 md:w-20 md:h-20 flex items-center justify-center rounded-full">
                <AwesomeIcon
                  icon={envelopeIcon}
                  className="w-5 h-5 md:w-8 md:h-8 text-white group-hover:rotate-[360deg] duration-1000"
                />
              </div>

...
const ArrowAnimated = () => {
  return (
    <div className="relative w-10 h-10 overflow-hidden bg-[#f8f5f1] dark:bg-darkeraquablue">
      <div className="absolute left-0 top-0 flex items-center justify-center w-full h-full transform transition-transform duration-300 group-hover:translate-x-full">
        <AwesomeIcon icon={arrowRightIcon} className="w-5 h-5 text-deepcharcoal dark:text-white" />
      </div>

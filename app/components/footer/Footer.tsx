...
const Footer = () => {
  ...
  return (
    <div className={`bg-midnightshadow px-4 pt-20 sm:pt-40 pb-12`}>
      <div className="max-w-1200 mx-auto w-full">
        <div className="grid grid-cols-12 gap-y-16 md:gap-x-16 lg:gap-x-20">
          ...
          <div className="col-span-12 md:col-span-4">
            ...
            <div className="flex flex-col gap-y-4">
              {navigationLinks(pathname, isAuthenticated, true).map((link, i) => (
